package com.yulongs.mybatis.plugins;

/**
* yulong 2016年11月17日 下午2:51:50 
*
**/
...
public class OraclePaginationPlugin extends PluginAdapter {  
    ...
    private void addPage(TopLevelClass topLevelClass,  
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType(  
                "com.yulongs.mybatis.plugins.Page"));  
        CommentGenerator commentGenerator = context.getCommentGenerator();  
        Field field = new Field();  
        field.setVisibility(JavaVisibility.PROTECTED);  
        field.setType(new FullyQualifiedJavaType("com.yulongs.mybatis.plugins.Page"));  
        field.setName(name);  
        ...
        method.addParameter(new Parameter(new FullyQualifiedJavaType(  
                "com.yulongs.mybatis.plugins.Page"), name));  
